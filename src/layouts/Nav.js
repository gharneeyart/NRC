...
// The return statement provides a cleanup function that removes the handleClickOutside event listener when the component unmounts or before the effect re-runs.
    ...
    return (
        <div className="w-full bg-white py-[2.49rem] fixed top-0 left-0 right-0 z-50 border border-[#D8D8D8] active:bg-gray-200 ">
            ...
            <div className={`lg:static container text-white text-[18.6px] flex flex-col gap-[3.375rem] top-24 rounded-sm lg:flex   ${
                ...
                <div className="flex flex-col lg:flex-row items-center gap-[1.625rem] xl:gap-[2.2rem] text-[18.6px] text-[#263238] lg:text-[#01320A] font-sans " ref={navRef}>
                    ...
                    <div className="w-[198px] bg-whitej mx-auto items-center justify-center relative block lg:hidden hover:bg-[#f0f4f1] hover:shadow-lg rounded-full  cursor-pointer active:bg-gray-200"onClick={openMenu}>
                    ...
                    {dropOpen && (
                        ...
                        <div>
                            <ul className="px-[10px] py-[10px] grid gap-[10px]">
                                ...
                                <li className="text-[#DB3E3E] hover:text-[#006B14]">Log Out</li>
                            </ul>
                        </div>
                    </div>
                    )}
                ...
                <div className="w-[198px] bg-white  gap-[23px] mx-auto items-center justify-center relative  hidden lg:block hover:bg-[#f0f4f1] hover:shadow-lg rounded-full  cursor-pointer active:bg-gray-200" onClick={openMenu}>
                    <div className="flex gap-[8px] items-center">
                        <div className="h-[51px] w-[51px] flex items-center justify-center text-lg text-[#006B14] text-center rounded-full bg-[#F0F7F6]"><h1>M.K</h1></div>
                        <div className="text-base text-[#3C3C3C]"><h3>Michael Kay</h3></div>
                        <div className="text-[#4F4F4F] text-4xl cursor-pointer ">
