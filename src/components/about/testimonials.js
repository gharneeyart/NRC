...
export default function Testimonial() {
    return(
        <div className='my-[88px] w-11/12 container mx-auto flex flex-col md:gap-[40px] gap-[58.54px] lg:h-[512px]'>
           ...
           <p className='lg:text-[20.66px] text-[14px] md:text-[18px] font-medium text-[#4E4E4E]'>See what travelers across Nigeria have to say about their experience with NRC Train Booking.</p>
           </div>
