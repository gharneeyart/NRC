...
export default function Nav({handleOpener}) {
  ...
  return (
    <div className="fixed left-0 right-0 z-50">
      <Marquee />
      <div className="w-full bg-white py-[0.8rem]  border border-[#D8D8D8]">
        <div className="w-11/12 container mx-auto flex items-center justify-between">
          ...
          >
            ...
            >
              ...
              {auth ? (
                <div className="w-full bg-white mx-auto items-center justify-center relative block lg:hidden">
                    ...
                    <div className="w-[166px] py-[4px] absolute top-14 right-0 bg-white rounded-[10px] text-[#111014] text-[16px] drop-shadow shadow-[#00000026] cursor-pointer">
                      <div>
                        <ul className="px-[10px] py-[10px] grid gap-[10px]">
                          ...
                          <li className="hover:text-[#006B14] on">
                           Reset Password
                          </li>
                          <li
                            className="text-[#DB3E3E] hover:text-[#006B14]"
                            onClick={logout}
                          >
                            Log Out
                          </li>
                ...
                <div className="flex flex-col text-center gap-[1.75rem] lg:flex-row lg:gap-[2.4rem]  lg:hidden">
                  <Link
                    href="/auth/signup"
                    className="border border-[#18A532] text-[#18A532] py-2 px-6 rounded-md"
                  >
                    Register
                  </Link>
                  <Link href="/auth/login">
                    <button className="w-full text-white bg-[#18A532] py-2 px-6 rounded-md">
                      Sign in
                    </button>
                  </Link>
                </div>
            ...
            {auth ? (
              <div className="w-[218px] bg-white gap-[23px] mx-auto items-center justify-center relative hidden lg:block">
                ...
                {dropOpen && (
                  <div className="w-full py-[4px] absolute top-14 right-0 bg-white rounded-[10px] text-[#111014] text-[16px] drop-shadow shadow-[#00000026] cursor-pointer ">
                    <div>
                      <ul className="px-[10px] py-[10px] grid gap-[10px]">
                        <li className="hover:text-[#006B14] ">My Tickets</li>
                        <li className="hover:text-[#006B14]"><ResetPassword/> </li>
                        <li
                          className="text-[#DB3E3E] hover:text-[#006B14]"
                          onClick={logout}
                        >
