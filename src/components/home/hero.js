  ...
  return (
    <div className="home-hero">
      <div className="w-11/12 container mx-auto pt-20 ">
        <div className="my-10 lg:mt-16 lg:mb-20 w-full text-center lg:text-left md:w-[70%] lg:w-1/2 xl:w-[45%] md:mx-auto lg:mx-0 text-white">
          <h1 className="font-bold w-full leading-[1.2] text-[28px] md:text-[44px] mb-5">
