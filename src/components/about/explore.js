...
export default function Explore() {
  return (
    <div className="w-11/12 container mx-auto mt-10 lg:mt-20 lg:py-[67px] py-12 flex flex-col gap-[40px] lg:gap-[55px] ">
      <div className="text-center space-y-2.5">
        <h1 className="font-semibold lg:text-[52px] text-[28px]">
          Explore Popular Destinations
        </h1>
        <p className="md:w-[668px] lg:w-[868px] xl:w-[1068px]  mx-auto lg:h-[64px] font-medium text-sm md:text-base lg:text-lg xl:text-[22px] text-[#4E4E4E]">
