...
export default function Mission() {
  return (
    ...
    <div className="text-black w-full items-center mt-12 lg:w-[90%] lg:grid grid-cols-2 mx-auto items-center 4xl:w-[80%] 4xl:gap-2">
      ...
      <div className="items-center lg:text-xl 2xl:text-2xl lg:gap-3 2xl:gap-10 4xl:gap-3 flex flex-col md:ml-4 lg:h-full lg:min-h-[500px] xl:h-full xl:min-h-[600px] lg:w-[90%] xl:w-[70%] w-90% mx-auto items-center px-7 lg:p-0 xl:p-0">
        <div>
