    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 backgd px-3 lg:p-0 max-w-[1700px] mx-auto">
      <div className=" p-3 md:px-10 md:py-14 lg:p-14 bg-white rounded-md shadow-md lg:rounded-none lg:shadow-none mt-3 lg:mt-0 mb-10 lg:mb-0">
        ...
        <form
          ...
          className="py-5 text-[14px] flex flex-col gap-6 "
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="border-2 outline-none rounded-sm px-3 py-2"
              />
              {errors.firstName && (
          ...
          <div className="grid gid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                className={`${
                  gender ? "text-black" : "text-[#2632388F]"
                }  border-2 rounded-sm px-3 py-2 outline-none`}
              >
            ...
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                className={`${
                  identification ? "text-black" : "text-[#2632388F]"
                } border-2 rounded-sm px-3 py-2 outline-none`}
              >
                <option value="" disabled hidden>
          ...
          <div className="flex items-baseline gap-2">
            <input
              ...
              name="terms"
              value="terms"
              className="outline-none bg-[#18A532] active:bg-[#18A532] px-5"
            />
            <span>
              By proceeding with the registration, I confirm that I haveread and
          ...
          <button className="bg-[#18A532] w-full text-white py-2 rounded-md shadow-sm">
            Sign Up
          </button>
          <p className="text-center ">
            Already have an account?{" "}
            <span className="text-[#18A532]">Sign in</span>
          </p>
        </form>
      </div>
      <div>
        <Image
          src={Train}
          alt="signup"
          className="h-[90%] w-full hidden lg:block"
        />
      </div>
    </div>
  );
