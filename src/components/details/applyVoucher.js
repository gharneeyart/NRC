export default function ApplyVoucher() {
  ...
  return (
    <div className="container border-[0.82px] lg:border-[1px] border-[#E2E2E2] w-full lg:w-[395px] xl:w-[408px] lg:rounded-[0.975rem] px-[1.333rem] xl:px-[18.33px] py-[29.3px] lg:py-[35.6px]">
        <div className="">
