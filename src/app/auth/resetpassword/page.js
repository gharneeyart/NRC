        ...
        <div className="w-full lg:w-1/2 bg-white rounded-lg shadow-lg p-3 md:px-10 md:py-14 lg:px-20 h-[500px] my-6 pt-6 flex flex-col lg:justify-center lg:shadow-none ">
          <div >
            ...
            <form onSubmit={handleSubmit(onSubmit)} noValidate className="e flex flex-col gap-4">
              ...
              {errors.password && <p className="text-red-600 mb-7">{errors.password.message}</p>}
              ...
              <input
                type="password"
                {...register("confirmPassword", {required: "Confirm new password",
                  pattern : {
                      message: "Please enter a new password!"
                  }
              })} 
              ...
              {errors.confirmPassword && <p className="text-red-600 mb-7">{errors.confirmPassword.message}</p>}
              <button
                type="submit"
