      ...
      <table className="w-full text-left">
        ...
        <tbody >
          <tr className="text-sm lg:text-[1rem] xl:text-[1.375rem] font-semibold">
            <td className="px-[0.703rem] lg:px-[1.878rem]  pt-[0.214rem] lg:pt-[0.779rem]">Korede Daniel</td>
            <td className="pt-[0.214rem] lg:pt-[0.779rem] ">Adult</td>
            <td className="pt-[0.214rem] lg:pt-[0.779rem]">CO1/1A</td>
          </tr>
          <tr className="flex flex-col px-[0.703rem] lg:px-[1.878rem] text-sm lg:text-[1rem] xl:text-[20px]">
            <td className="text-[#6D6D6D] pt-[6.36px] lg:pt-[9px]">koredex@gmail.com</td> 
            <td className="text-[#6D6D6D] pt-[4.24px] lg:pt-[6px]">08162458760</td>
          </tr>
        </tbody>
      </table>
      </div>
