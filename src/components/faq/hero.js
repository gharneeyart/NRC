    ...
    return(
        <div className="faq-hero">
            <div className="w-11/12 container mx-auto  ">
                ...
                <h1 className="font-bold w-full  text-[28px] md:text-[40px] mb-4">Frequently Asked Questions</h1>
                <p className="w-full font-medium text-sm md:text-base lg:text-lg text-[#DFDFDF]">Have Questions? We are here to help.</p>
                </div>
