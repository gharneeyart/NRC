...
export default function News() {
  return (
    <div className="w-11/12 container mx-auto space-y-10 lg:space-y- xl:space py-12">
      <div>
        <h1 className="text-3xl font-bold text-center lg:text-5xl  mb-3">
          News & Updates
        </h1>
        <p className=" text-center text-sm md:text-base lg:text-lg xl:text-[22px] font-medium text-[#4E4E4E]">
