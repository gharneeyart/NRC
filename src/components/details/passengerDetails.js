        ...
        <table className="w-full text-left">
          <thead className="bg-[#F5F5F5]">
            <tr className="text-sm lg:text-[1.2rem] xl:text-[1.5rem]">
              <th className="py-[0.813rem] px-[1.326rem] lg:px-[1.878rem]">
                Name
              </th>
            ...
            {passengers.map((passenger, index) => (
              <div key={index}>
                <tr className="text-sm lg:text-[1rem] xl:text-[1.375rem] font-semibold">
                  <td className="px-[0.703rem] lg:px-[1.878rem] pt-[0.214rem] lg:pt-[0.779rem]">
                    {passenger.name}
                  </td>
                ...
                <tr className="flex flex-col px-[0.703rem] lg:px-[1.878rem] text-sm lg:text-[1rem] xl:text-[20px]">
                  <td className="text-[#6D6D6D] pt-[6.36px] lg:pt-[9px]">
                    {passenger.email}
                  </td>
                  <td className="text-[#6D6D6D] pt-[4.24px] lg:pt-[6px]">
                    {passenger.phone}
                  </td>
                </tr>
              </div>
