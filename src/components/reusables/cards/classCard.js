...
// export default function ClassCard({ myBookings, train, timeOfDay }) {
//   const { setSelectedClass, setSelectedTrain, setTimeOfDay } = useSearchStore();

//   const handleSelectClass = () => {
//     // Set the selected class, train, and time of day when the user clicks "Book Now"
//     setSelectedClass(myBookings?.class);
...
//         </div>
//         <div className="flex flex-col gap-[10px]">
//           <h2 className="font-semibold text-[18px] xl:text-[26px]">
//             {myBookings?.class}
//           </h2>
//           <div className="flex gap-2 font-medium text-[15px] xl:text-[22px] items-center">
//             <p className="">Adult - {myBookings?.priceAdult}</p> |
//             <p className="">Child - {myBookings?.priceChild}</p>
//           </div>
//           <p className="font-medium text-[15px] xl:text-[22px] text-[#767676]">
//             Reserved - {myBookings?.reserves}
//           </p>
//         </div>
//         <Link
//           href="/bookaseat"
