            ...
            <table className="w-full min-w-max border-collapse border">
              ...
              <tbody>
                {Lagos.map((lagos, index) => (
                  <tr key={lagos.id} className="border border-gray-300">
                    <td className="border p-2 text-start">{index + 1}</td>
                    <td className="border p-2 text-start">{lagos?.code}</td>
                    <td className="border p-2 text-start">{lagos?.name}</td>
                    <td className="border p-2 text-start">{lagos?.arrivalTime}</td>
                    <td className="border p-2 text-start">{lagos?.departureTime}</td>
                    <td className="border p-2 text-start">{lagos?.distance}</td>
                  </tr>
                ))}
              </tbody>
            </table>
