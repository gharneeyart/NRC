      ...
      <table className=" px-6 lg:px-0 w-full">
        <thead className="bg-[#F2FAF4] ">
          <tr>
            ...
            <th className=" py-3 px-3 text-left font-semibold w-[171px] lg:w-[270px]">
              Station Name
            </th>
        ...
        <tbody>
          {Schedule.map((item, index) => (
            <tr
              key={item.id}
              className="border border-gray-300 text-start font-medium text-sm  text-[#263238] lg:text-[18px]  "
            >
